  ...
  return (
    <div className={styles.card}>
      <div className={styles.card__row}>
        ...
        <div
          className={`${styles.card__content__slot__chip} ${styles[`card__content__slot__chip--${status}`]}`}
        >
          <div
            className={`${styles.card__content__slot__chip__label} ${styles[`card__content__slot__chip__label--${status}`]}`}
          >
            <i
              className={
                status === 'completed'
      ...
      <div className={styles.card__content}>
        {slots.map(slot => (
          <div
            className={`${styles.card__content__slot} ${styles[`card__content__slot--${!!slot?.address ? 'completed' : 'pending'}`]}`}
          >
